...
control "KEYC-01-000049" do
  ...
  desc  "check", "
    ...
    Verify Keycloak are configured to notify the system administrators and ISSO for account disabling actions.
    
    If Keyclaok are not configured to notify the system administrators and ISSO for account disabling actions, this is a finding.
